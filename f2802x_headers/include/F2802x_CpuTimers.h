...
// Write 32-Bit Timer Value:
#define WriteCpuTimer0Counter(Value) CpuTimer0Regs.TIM.all = Value
...
// Write 32-Bit Timer Value:
#define WriteCpuTimer1Counter(Value) CpuTimer1Regs.TIM.all = Value
#define WriteCpuTimer2Counter(Value) CpuTimer2Regs.TIM.all = Value
